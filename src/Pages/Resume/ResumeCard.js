...
const ResumeCard = ({ item }) => {
  ...
  return (
    <>
      <div>
        <div className="flex items-center space-s-2 mb-4 ">
        ...
        <div
          ...
          className="py-4 pr-5 pl-3 space-y-2 mb-6 rounded-lg dark:border-[#212425] dark:border-2"
        >
          <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">
            {item?.date}
          </span>
          <h3 className="text-xs dark:text-white">{item?.title}</h3>
        ...
        <div
          ...
          className="py-4 pr-5 pl-3 space-y-2 rounded-lg mb-6 dark:border-[#212425] dark:border-2"
        >
          <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">
            {item?.date1}
          </span>
          <h3 className="text-xs dark:text-white">{item?.title1}</h3>
        ...
        <div
          ...
          className="py-4 pr-5 pl-3 space-y-2 rounded-lg dark:border-[#212425] dark:border-2"
        >
          <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">
            {item?.date2}
          </span>
