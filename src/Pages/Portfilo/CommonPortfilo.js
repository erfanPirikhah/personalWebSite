...
//   return (
//     <>
//       <PageTitle title="نمونه کارها"></PageTitle>
//       {/* End pagetitle */}
...
//             <div className="py-12">
//               <h2 className="after-effect after:right-52 lg:mt-0">
//                 نمونه کارها
//               </h2>
...
//                 <li
//                   className={`${
//                     test === "Logo" ? "text-[#FA5252]" : "fillter-btn mr-0"
//                   } mr-4 md:mx-4`}
...
//                   />
//                   <h2 className="text-[#ef4060] dark:hover:text-[#FA5252] text-4xl text-center font-bold">پروژه {singleData.tag}</h2>
//                   <div className="grid grid-cols-1 lg:grid-cols-2 my-6">
//                     <div className="space-y-2">
//                       <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
//                         <FiFilePlus className="sm:text-lg hidden sm:block ml-2  md:text-xl" />
//                         پروژه :&nbsp;{" "}
//                         <span className="font-medium ">وبسایت</span>
//                       </p>
//                       <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
//                         <FiCode className="text-lg ml-2 hidden sm:block " />
//                         ابزار/زبان :&nbsp;
...
//                         <FiUser className="text-lg ml-2 hidden sm:block" />
//                         مشتری :&nbsp;
//                         <span className="font-medium ">
//                           {singleData?.client}
//                         </span>
//                       </p>
//                       <p className="dark:text-white flex items-center text-[15px] sm:text-lg ">
//                         <FiExternalLink className="text-lg ml-2 hidden sm:block" />
//                         پیشنمایش :&nbsp;
...
//                     </div>
//                   </div>
//                   <p className="dark:text-white text-justify text-2line font-normal text-[15px] sm:text-sm">
