...
import pdfCV from "../assets/erfanPirikhahCV.pdf";
  ...
  return (
    <div>
      <div className="w-full mb-6 lg:mb-0  mx-auto relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        <img
          src={img}
          className="w-[200px] absolute left-[50%] transform -translate-x-[50%] h-[200px] drop-shadow-xl mx-auto  rounded-[20px] -mt-[140px]"
          alt=""
        />
        ...
        <div className="pt-[100px] pb-8">
          ...
          <h3 className="mb-4 text-[#7B7B7B] inline-block dark:bg-[#1D1D1D] px-5 py-1.5 rounded-lg dark:text-[#A6A6A6] ">
            Backend Developer at Hamrah Houshmand | Nodejs Developer |{" "}
          </h3>
          ...
          <div className="flex justify-evenly space-s-3">
            ...
            {/* drop link add here */}
            <a
              href="https://www.instagram.com/erfan.pirikhah/"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/erfan-pirikhah-1628091a2/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <button
            onClick={donnloadPDF}
            className="flex justify-between items-center mx-auto bg-gradient-to-r from-[#FA5252] to-[#DD2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476]  to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6"
          >
            Download My CV
