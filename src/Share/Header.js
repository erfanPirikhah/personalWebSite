        ...
        <header className="flex justify-between items-center fixed top-0 left-0 w-full lg:static z-[1111111111]  ">
          ...
          >
            ...
            <ul
              className={`${
                menuOpen
                  ? "block lg:hidden absolute right-0 rounded-b-[20px] top-20 z-[22222222222222] w-full bg-white dark:bg-[#1D1D1D] drop-shadow-lg py-4 "
                  : "flex my-12 "
              }`}
            >
              {menuItem.map((item) => (
                ...
                >
                  <NavLink
                    ...
                    className={`${
                      ...
                      menuOpen
                        ? " pr-4 dark:text-white hover:text-[#FA5252] dark:hover:text-[#FA5252]  "
              ...
              {!check ? (
                <span
                  onClick={() => handle("dark")}
                  className="bg-white w-[40px] hover:text-white hidden h-[40px] rounded-full lg:flex justify-center items-center text-black hover:bg-[#ef4060] transition-all duration-300 ease-in-out cursor-pointer mr-2 "
                >
                  <FiMoon className="  text-3xl" />
                </span>
              ) : (
                <span
                  onClick={() => handle("light")}
                  className="bg-[#4D4D4D] w-[40px] h-[40px] hidden rounded-full lg:flex justify-center items-center hover:bg-[#ef4060] transition-all duration-300 ease-in-out cursor-pointer mr-2"
                >
                  <FiSun className="text-white text-3xl" />
                </span>
              )}
